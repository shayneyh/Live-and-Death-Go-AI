...
eyeSpotstest = generateTuples('0102030405060714')
gametest = [apiecestest, dpiecestest, availstest, eyeSpotstest, dimstest]
gamestatetest = goMain.generateInitialState(gametest[0], gametest[1], gametest[2], gametest[3], gametest[4])
goObject = go.GoGame(gamestatetest.player, gamestatetest.moves, gamestatetest.board, gamestatetest.connectedPieces, gamestatetest.survivalState, gamestatetest.eyes)
problems.append(goObject)
...
dimstest = (9,6)
availstest = generateTuples('0010412030405170')
...
eyeSpotstest = generateTuples('2021000111')
gametest = [apiecestest, dpiecestest, availstest, eyeSpotstest, dimstest]
gamestatetest = goMain.generateInitialState(gametest[0], gametest[1], gametest[2], gametest[3], gametest[4])
goObject = go.GoGame(gamestatetest.player, gamestatetest.moves, gamestatetest.board, gamestatetest.connectedPieces, gamestatetest.survivalState, gamestatetest.eyes)
problems.append(goObject)
...
dimstest = (6,6)
availstest = generateTuples('102223210002')
eyeSpotstest = generateTuples('02010010111220212223')
gametest = [apiecestest, dpiecestest, availstest, eyeSpotstest, dimstest]
gamestatetest = goMain.generateInitialState(gametest[0], gametest[1], gametest[2], gametest[3], gametest[4])
goObject = go.GoGame(gamestatetest.player, gamestatetest.moves, gamestatetest.board, gamestatetest.connectedPieces, gamestatetest.survivalState, gamestatetest.eyes)
problems.append(goObject)
...
#13. Intermediate 7
dpiecestest = generateTuples('300211223241')
# white
apiecestest = generateTuples('00121323334352515040')
dimstest = (7,6)
availstest = generateTuples('011020213142')
...
# dimstest = (7,6)
# availstest = generateTuples('0110202130314042')
# eyeSpotstest = generateTuples('011020213031')
gametest = [apiecestest, dpiecestest, availstest, eyeSpotstest, dimstest]
gamestatetest = goMain.generateInitialState(gametest[0], gametest[1], gametest[2], gametest[3], gametest[4])
goObject = go.GoGame(gamestatetest.player, gamestatetest.moves, gamestatetest.board, gamestatetest.connectedPieces, gamestatetest.survivalState, gamestatetest.eyes)
